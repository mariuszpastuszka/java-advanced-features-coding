...
public class BestGradeExample {
    ...
    public static void main(String[] args) {
        ...
        Stream.of(
                new StudentWithGrade("Maria", "W", null),
                new StudentWithGrade("Michael", "B", 1),
                new StudentWithGrade("Jan", "Kowalski", 1)
        )
                .filter(student -> student.finalGrade() != null)
                .max((student1, student2) -> student1.finalGrade().compareTo(student2.finalGrade()))
        ...
        studentWithGrades.stream()
                .filter(student -> student.finalGrade() != null)
//                .sorted((o1, o2) -> o2.finalGrade().compareTo(o1.finalGrade())) // check if it works
//                .sorted((o1, o2) -> -o1.finalGrade().compareTo(o2.finalGrade())) // check if it works
                .sorted(Comparator.comparing(StudentWithGrade::finalGrade).reversed()) // check if it works
                .toList()
